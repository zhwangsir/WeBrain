...
function resolveGoogleChatAccountImpl(params: { cfg: WineryClawConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: WineryClawConfig) => {
...
function createGoogleChatCfg(): WineryClawConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
