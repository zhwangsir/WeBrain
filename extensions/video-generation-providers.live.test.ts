...
const providerFilter = parseCsvFilter(process.env.WINERYCLAW_LIVE_VIDEO_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.WINERYCLAW_LIVE_VIDEO_GENERATION_MODELS);
