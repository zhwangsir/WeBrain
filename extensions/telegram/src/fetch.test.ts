...
describe("resolveTelegramFetch", () => {
  ...
  it("uses the WineryClaw debug proxy URL when no explicit proxy fetch is provided", async () => {
  ...
  it("keeps resolver-scoped transport policy for WineryClaw proxy fetches", async () => {
