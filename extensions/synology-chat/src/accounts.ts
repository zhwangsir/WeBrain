...
/** Extract the channel config from the full WineryClaw config object. */
function getChannelConfig(cfg: WineryClawConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: WineryClawConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.WINERYCLAW_BOT_NAME ?? "WineryClaw";
