...
function mergeZaloAccountConfig(cfg: WineryClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: WineryClawConfig): ResolvedZaloAccount[] {
