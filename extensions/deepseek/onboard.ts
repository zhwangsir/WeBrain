...
export function applyDeepSeekProviderConfig(cfg: WineryClawConfig): WineryClawConfig {
...
export function applyDeepSeekConfig(cfg: WineryClawConfig): WineryClawConfig {
