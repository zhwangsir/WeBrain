...
function mergeSignalAccountConfig(cfg: WineryClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: WineryClawConfig): ResolvedSignalAccount[] {
