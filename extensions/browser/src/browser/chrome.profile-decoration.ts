 ...
 */
export function decorateWineryClawProfile(
  userDataDir: string,
  opts?: { name?: string; color?: string },
) {
  const desiredName = opts?.name ?? DEFAULT_WINERYCLAW_BROWSER_PROFILE_NAME;
  const desiredColor = (opts?.color ?? DEFAULT_WINERYCLAW_BROWSER_COLOR).toUpperCase();
