...
export function applyOpencodeZenProviderConfig(cfg: WineryClawConfig): WineryClawConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeZenConfig(cfg: WineryClawConfig): WineryClawConfig {
