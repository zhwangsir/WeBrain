 ...
 */
export function applyChutesProviderConfig(cfg: WineryClawConfig): WineryClawConfig {
 ...
 */
export function applyChutesConfig(cfg: WineryClawConfig): WineryClawConfig {
...
export function applyChutesApiKeyConfig(cfg: WineryClawConfig): WineryClawConfig {
