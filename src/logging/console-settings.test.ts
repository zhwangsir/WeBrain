...
let originalWineryClawTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalWineryClawTestConsole = process.env.WINERYCLAW_TEST_CONSOLE;
  process.env.WINERYCLAW_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalWineryClawTestConsole === undefined) {
    delete process.env.WINERYCLAW_TEST_CONSOLE;
  } else {
    process.env.WINERYCLAW_TEST_CONSOLE = originalWineryClawTestConsole;
  }
