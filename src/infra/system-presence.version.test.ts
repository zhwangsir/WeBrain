  ...
  return withEnvAsync(
    {
      ...
      WINERYCLAW_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when WINERYCLAW_VERSION is not set", async () => {
  ...
  it("prefers WINERYCLAW_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over WINERYCLAW_SERVICE_VERSION when WINERYCLAW_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        WINERYCLAW_VERSION: " ",
        WINERYCLAW_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when WINERYCLAW_VERSION and WINERYCLAW_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        WINERYCLAW_VERSION: " ",
        WINERYCLAW_SERVICE_VERSION: "\t",
