...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): WineryClawConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): WineryClawConfig {
  return {
