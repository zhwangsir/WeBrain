...
export function buildServiceEnvironment(params: {
  ...
  return {
    ...
    WINERYCLAW_PROFILE: profile,
    WINERYCLAW_GATEWAY_PORT: String(port),
    WINERYCLAW_LAUNCHD_LABEL: resolvedLaunchdLabel,
    WINERYCLAW_SYSTEMD_UNIT: systemdUnit,
    WINERYCLAW_WINDOWS_TASK_NAME: resolveGatewayWindowsTaskName(profile),
    WINERYCLAW_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    WINERYCLAW_SERVICE_KIND: GATEWAY_SERVICE_KIND,
    WINERYCLAW_SERVICE_VERSION: VERSION,
  };
}
...
export function buildNodeServiceEnvironment(params: {
  ...
  const gatewayToken = normalizeOptionalString(env.WINERYCLAW_GATEWAY_TOKEN);
  return {
    ...buildCommonServiceEnvironment(env, sharedEnv),
    WINERYCLAW_GATEWAY_TOKEN: gatewayToken,
    WINERYCLAW_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    WINERYCLAW_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    WINERYCLAW_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    WINERYCLAW_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    WINERYCLAW_LOG_PREFIX: "node",
    WINERYCLAW_SERVICE_MARKER: NODE_SERVICE_MARKER,
    WINERYCLAW_SERVICE_KIND: NODE_SERVICE_KIND,
    WINERYCLAW_SERVICE_VERSION: VERSION,
  };
}
...
function buildCommonServiceEnvironment(
  ...
  const serviceEnv: Record<string, string | undefined> = {
    ...
    WINERYCLAW_STATE_DIR: sharedEnv.stateDir,
    WINERYCLAW_CONFIG_PATH: sharedEnv.configPath,
  };
...
function resolveSharedServiceEnvironmentFields(
  ...
  const stateDir = env.WINERYCLAW_STATE_DIR;
  const configPath = env.WINERYCLAW_CONFIG_PATH;
