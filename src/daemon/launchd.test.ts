...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    ...
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", WINERYCLAW_PROFILE: "default" },
    });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when WINERYCLAW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.openclaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when WINERYCLAW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", WINERYCLAW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.openclaw.jbphoenix.plist",
    },
    {
      name: "prefers WINERYCLAW_LAUNCHD_LABEL over WINERYCLAW_PROFILE",
      env: {
        HOME: "/Users/test",
        WINERYCLAW_PROFILE: "jbphoenix",
        WINERYCLAW_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from WINERYCLAW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        WINERYCLAW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty WINERYCLAW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        WINERYCLAW_PROFILE: "myprofile",
        WINERYCLAW_LAUNCHD_LABEL: "   ",
      },
  ...
  it("rejects invalid launchd labels that contain path separators", () => {
    expect(() =>
      resolveLaunchAgentPlistPath({
        HOME: "/Users/test",
        WINERYCLAW_LAUNCHD_LABEL: "../evil/label",
      }),
