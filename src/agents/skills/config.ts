...
export function isConfigPathTruthy(config: WineryClawConfig | undefined, pathStr: string): boolean {
...
export function resolveBundledAllowlist(config?: WineryClawConfig): string[] | undefined {
