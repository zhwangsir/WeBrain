...
function makeFallbacksOnlyCfg(): WineryClawConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeProviderFallbackCfg(provider: string): WineryClawConfig {
  return makeCfg({
    agents: {
      defaults: {
        model: {
...
// Internal WineryClaw compatibility marker, not a provider API contract.
