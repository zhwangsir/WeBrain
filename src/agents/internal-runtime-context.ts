export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_WINERYCLAW_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_WINERYCLAW_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[WINERYCLAW_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[WINERYCLAW_INTERNAL_CONTEXT_END]]";
