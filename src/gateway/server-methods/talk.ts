...
import type { WineryClawConfig, TtsConfig, TtsProviderConfigMap } from "../../config/types.js";
import {
...
function buildTalkTtsConfig(
  ...
  | { cfg: WineryClawConfig; provider: string; providerConfig: TalkProviderConfig }
