...
export function hasAmbiguousGatewayAuthModeConfig(cfg: WineryClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: WineryClawConfig): void {
