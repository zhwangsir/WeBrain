...
export function resolveHooksConfig(cfg: WineryClawConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: WineryClawConfig, defaultAgentId: string): Set<string> {
