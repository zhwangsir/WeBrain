...
const EMPTY_CFG = {} as WineryClawConfig;
...
async function applySubagentModelPatch(cfg: WineryClawConfig) {
...
function createAllowlistedAnthropicModelCfg(): WineryClawConfig {
  return {
    agents: {
      defaults: {
