...
const ensureWineryClawModelsJsonMock = vi.fn<
...
vi.mock("../agents/agent-paths.js", () => ({
  resolveWineryClawAgentDir: () => "/tmp/agent",
}));

vi.mock("../agents/models-config.js", () => ({
  ensureWineryClawModelsJson: (config: unknown, agentDir: unknown) =>
    ensureWineryClawModelsJsonMock(config, agentDir),
}));
...
describe("gateway startup primary model warmup", () => {
  ...
  beforeEach(() => {
    ensureWineryClawModelsJsonMock.mockClear();
  ...
  it("prewarms an explicit configured primary model", async () => {
    ...
    expect(ensureWineryClawModelsJsonMock).toHaveBeenCalledWith(cfg, "/tmp/agent");
  ...
  it("skips warmup when no explicit primary model is configured", async () => {
    ...
    expect(ensureWineryClawModelsJsonMock).not.toHaveBeenCalled();
