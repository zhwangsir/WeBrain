...
function resolveResolutionLimits(config: WineryClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: WineryClawConfig): SecretProviderConfig {
