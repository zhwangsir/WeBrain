...
function buildNoImageGenerationModelConfiguredMessage(cfg: WineryClawConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: WineryClawConfig }) {
