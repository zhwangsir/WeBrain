...
function resolveSpeechProviderPluginEntries(cfg?: WineryClawConfig): SpeechProviderPlugin[] {
...
export function listSpeechProviders(cfg?: WineryClawConfig): SpeechProviderPlugin[] {
