...
export function createStatusScanConfig<T extends object = WineryClawConfig>(
  overrides: T = {} as T,
): WineryClawConfig & T {
  return {
    session: {},
...
export function createStatusMemorySearchConfig(): WineryClawConfig {
