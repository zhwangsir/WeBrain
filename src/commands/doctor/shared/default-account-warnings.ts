...
export function collectMissingDefaultAccountBindingWarnings(cfg: WineryClawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: WineryClawConfig): string[] {
  const warnings: string[] = [];
