...
function resolveDefaultAccountId(cfg: WineryClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: WineryClawConfig): boolean {
...
export function summarizeBindings(cfg: WineryClawConfig, bindings: AgentBinding[]): string[] {
