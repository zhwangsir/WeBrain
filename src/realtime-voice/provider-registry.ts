...
function resolveRealtimeVoiceProviderEntries(cfg?: WineryClawConfig): RealtimeVoiceProviderPlugin[] {
...
export function listRealtimeVoiceProviders(cfg?: WineryClawConfig): RealtimeVoiceProviderPlugin[] {
