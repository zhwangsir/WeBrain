...
declare const __WINERYCLAW_VERSION__: string | undefined;
...
function resolveVersionFromRuntimeSources(params: {
  ...
  const preferredCandidates =
    params.preference === "env-first"
      ? [params.env["WINERYCLAW_VERSION"], params.runtimeVersion]
      : [params.runtimeVersion, params.env["WINERYCLAW_VERSION"]];
  return (
    firstNonEmpty(
      ...preferredCandidates,
      params.env["WINERYCLAW_SERVICE_VERSION"],
...
export function resolveCompatibilityHostVersion(
  ...
  const explicitCompatibilityVersion = firstNonEmpty(env.WINERYCLAW_COMPATIBILITY_HOST_VERSION);
...
// Single source of truth for the current WineryClaw version.
// - Embedded/bundled builds: injected define or env var.
// - Dev/npm builds: package.json.
export const VERSION = resolveBinaryVersion({
  moduleUrl: import.meta.url,
  injectedVersion: typeof __WINERYCLAW_VERSION__ === "string" ? __WINERYCLAW_VERSION__ : undefined,
  bundledVersion: process.env.WINERYCLAW_BUNDLED_VERSION,
});
