...
import type {
  ...
  WineryClawPluginApi as CoreWineryClawPluginApi,
...
import type {
  ...
  WineryClawPluginApi as SharedWineryClawPluginApi,
...
import type { WineryClawPluginApi } from "../types.js";
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("keeps shared plugin-sdk types aligned", () => {
    ...
    expectTypeOf<CoreWineryClawPluginApi>().toMatchTypeOf<WineryClawPluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<PluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<ChannelMessageActionContext>();
    expectTypeOf<CoreWineryClawPluginApi>().toMatchTypeOf<SharedWineryClawPluginApi>();
