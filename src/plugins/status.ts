...
import { normalizeWineryClawVersionBase } from "../config/version.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeWineryClawVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeWineryClawVersionBase(plugin.version) ??
    plugin.version
  );
}
