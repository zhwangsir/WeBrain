...
export function applyProviderDefaultModel(cfg: WineryClawConfig, modelRef: string): WineryClawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: WineryClawConfig; modelId: string; modelRef: string; profileId: string } {
