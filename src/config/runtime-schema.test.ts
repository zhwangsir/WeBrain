...
import type { ConfigFileSnapshot, WineryClawConfig } from "./types.js";

const mockLoadConfig = vi.hoisted(() => vi.fn<() => WineryClawConfig>());
...
function makeSnapshot(params: { valid: boolean; config?: WineryClawConfig }): ConfigFileSnapshot {
  return {
