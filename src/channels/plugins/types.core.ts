...
export type ChannelAgentToolFactory = (params: { cfg?: WineryClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: WineryClawConfig; accountId?: string | null }) => string[];
