...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: WineryClawConfig): string | undefined {
  ...
  function listAccountIds(cfg: WineryClawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: WineryClawConfig): string {
