...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['openclaw agents set-identity --agent main --name "WineryClaw" --emoji "😋"', "Set name + emoji."],
  ...
  [
    "openclaw agents set-identity --identity-file ~/.wineryclaw/workspace/IDENTITY.md --agent main",
