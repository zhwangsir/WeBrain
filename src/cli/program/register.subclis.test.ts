...
describe("registerSubCliCommands", () => {
  ...
  const originalDisableLazySubcommands = process.env.WINERYCLAW_DISABLE_LAZY_SUBCOMMANDS;
  ...
  beforeEach(() => {
    if (originalDisableLazySubcommands === undefined) {
      delete process.env.WINERYCLAW_DISABLE_LAZY_SUBCOMMANDS;
    } else {
      process.env.WINERYCLAW_DISABLE_LAZY_SUBCOMMANDS = originalDisableLazySubcommands;
    }
