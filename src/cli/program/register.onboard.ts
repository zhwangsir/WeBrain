...
export function registerOnboardCommand(program: Command) {
  const command = program
    ...
    .option("--workspace <dir>", "Agent workspace directory (default: ~/.wineryclaw/workspace)")
    .option(
      "--reset",
  ...
  command
    ...
    .option(
      ...
      "Gateway token SecretRef env var name (token auth; e.g. WINERYCLAW_GATEWAY_TOKEN)",
    )
