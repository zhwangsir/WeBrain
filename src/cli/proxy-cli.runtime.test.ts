...
describe("proxy cli runtime", () => {
  const envKeys = [
    ...
    "WINERYCLAW_DEBUG_PROXY_CERT_DIR",
  ...
  beforeEach(() => {
    ...
    process.env.WINERYCLAW_DEBUG_PROXY_CERT_DIR = path.join(tempDir, "certs");
    delete process.env.WINERYCLAW_DEBUG_PROXY_ENABLED;
    delete process.env.WINERYCLAW_DEBUG_PROXY_SESSION_ID;
