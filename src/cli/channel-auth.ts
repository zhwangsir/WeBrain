...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: WineryClawConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: WineryClawConfig, mode: ChannelAuthMode): string {
