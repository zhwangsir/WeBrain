...
describe("plugin activation boundary", () => {
  ...
  let browserHelpersPromise:
    | Promise<{
        ...
        DEFAULT_WINERYCLAW_BROWSER_COLOR: typeof import("./plugin-sdk/browser-config.js").DEFAULT_WINERYCLAW_BROWSER_COLOR;
        DEFAULT_WINERYCLAW_BROWSER_PROFILE_NAME: typeof import("./plugin-sdk/browser-config.js").DEFAULT_WINERYCLAW_BROWSER_PROFILE_NAME;
  ...
  function importBrowserHelpers() {
    browserHelpersPromise ??= Promise.all([
      ...
      DEFAULT_WINERYCLAW_BROWSER_COLOR: config.DEFAULT_WINERYCLAW_BROWSER_COLOR,
      DEFAULT_WINERYCLAW_BROWSER_PROFILE_NAME: config.DEFAULT_WINERYCLAW_BROWSER_PROFILE_NAME,
  ...
  it("keeps browser helper imports cold and loads only narrow browser helper surfaces on use", async () => {
    ...
    expect(browser.DEFAULT_WINERYCLAW_BROWSER_COLOR).toBe("#FF4500");
    expect(browser.DEFAULT_WINERYCLAW_BROWSER_PROFILE_NAME).toBe("openclaw");
