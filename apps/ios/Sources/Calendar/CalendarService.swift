...
final class CalendarService: CalendarServicing {
    func events(params: WineryClawCalendarEventsParams) async throws -> WineryClawCalendarEventsPayload {
        ...
        let payload = selected.map { event in
            WineryClawCalendarEventPayload(
        ...
        return WineryClawCalendarEventsPayload(events: payload)
    }
    ...
    func add(params: WineryClawCalendarAddParams) async throws -> WineryClawCalendarAddPayload {
        ...
        let payload = WineryClawCalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return WineryClawCalendarAddPayload(event: payload)
    }
