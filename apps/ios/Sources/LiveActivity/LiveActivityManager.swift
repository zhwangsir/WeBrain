...
final class LiveActivityManager {
    ...
    private var currentActivity: Activity<WineryClawActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = WineryClawActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<WineryClawActivityAttributes>.activities
    ...
    private func updateCurrent(state: WineryClawActivityAttributes.ContentState) {
    ...
    private func connectingState() -> WineryClawActivityAttributes.ContentState {
        WineryClawActivityAttributes.ContentState(
    ...
    private func idleState() -> WineryClawActivityAttributes.ContentState {
        WineryClawActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> WineryClawActivityAttributes.ContentState {
        WineryClawActivityAttributes.ContentState(
