...
final class PeekabooBridgeHostCoordinator {
    ...
    private var services: WineryClawPeekabooBridgeServices?
    ...
    private static var openclawSocketPath: String {
        ...
        return Self.makeSocketPath(for: "WineryClaw", in: base)
    }
    ...
    private func startIfNeeded() async {
        ...
        let services = WineryClawPeekabooBridgeServices()
...
@MainActor
private final class WineryClawPeekabooBridgeServices: PeekabooBridgeServiceProviding {
