...
enum ExecApprovalsStore {
    ...
    static func fileURL() -> URL {
        WineryClawPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        WineryClawPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
    ...
    private static func ensureSecureStateDirectory() {
        let url = WineryClawPaths.stateDirURL
        do {
