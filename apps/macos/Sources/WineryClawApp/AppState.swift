...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = WineryClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = WineryClawConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: WineryClawConfigFile.loadDict(),
        ...
        WineryClawConfigFile.saveDict(synced.root)
    }
