...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: WineryClawProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": WineryClawProtocol.AnyCodable("start"),
                "name": WineryClawProtocol.AnyCodable("bash"),
            ],
            summary: nil)
