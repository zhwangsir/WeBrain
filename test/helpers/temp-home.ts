...
function restoreEnv(snapshot: EnvSnapshot) {
  ...
  restoreKey("WINERYCLAW_HOME", snapshot.openclawHome);
...
function setTempHome(base: string) {
  ...
  // Ensure tests using HOME isolation aren't affected by leaked WINERYCLAW_HOME.
  delete process.env.WINERYCLAW_HOME;
  process.env.WINERYCLAW_STATE_DIR = path.join(base, ".openclaw");
