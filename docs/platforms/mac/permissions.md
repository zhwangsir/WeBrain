...
- Same path: run the app from a fixed location (for WineryClaw, `dist/WineryClaw.app`).
...
Workaround: move files into the WineryClaw workspace (`~/.wineryclaw/workspace`) if you want to avoid per-folder grants.
