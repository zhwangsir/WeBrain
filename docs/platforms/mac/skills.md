...
The macOS app surfaces WineryClaw skills via the gateway; it does not parse skills locally.
...
- The app stores keys in `~/.wineryclaw/wineryclaw.json` under `skills.entries.<skillKey>`.
