---
summary: "macOS IPC architecture for WineryClaw app, gateway node transport, and PeekabooBridge"
read_when:
  - Editing IPC contracts or menu bar app IPC
title: "macOS IPC"
---

# WineryClaw macOS IPC architecture
...
- Host preference order (client-side): Peekaboo.app → Claude.app → WineryClaw.app → local execution.
