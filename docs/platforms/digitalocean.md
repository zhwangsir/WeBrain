---
summary: "WineryClaw on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up WineryClaw on DigitalOcean
  - Looking for cheap VPS hosting for WineryClaw
title: "DigitalOcean (Platform)"
---

# WineryClaw on DigitalOcean

## Goal

Run a persistent WineryClaw Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
...
- `~/.wineryclaw/workspace/` — workspace (SOUL.md, memory, etc.)
