...
summary: "How to contribute to the WineryClaw threat model"
read_when:
  - You want to contribute security findings or threat scenarios
  - Reviewing or updating the threat model
---

# Contributing to the WineryClaw Threat Model

Thanks for helping make WineryClaw more secure. This threat model is a living document and we welcome contributions from anyone - you don't need to be a security expert.
...
- Which parts of WineryClaw are affected (CLI, gateway, channels, ClawHub, MCP servers, etc.)
...
- [WineryClaw Threat Model](/security/THREAT-MODEL-ATLAS)
...
Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the WineryClaw security hall of fame for significant contributions.
