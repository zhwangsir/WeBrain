...
read_when:
  - You want Zalo Personal (unofficial) support in WineryClaw
...
Zalo Personal support for WineryClaw via a plugin, using native `zca-js` to automate a normal Zalo user account.
