---
summary: "Updating WineryClaw safely (global install or source), plus rollback strategy"
read_when:
  - Updating WineryClaw
...
The auto-updater is off by default. Enable it in `~/.wineryclaw/wineryclaw.json`:
