...
const ENV_PROVIDER = "WINERYCLAW_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "WINERYCLAW_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "WINERYCLAW_CONTROL_UI_I18N_THINKING";
const ENV_PI_EXECUTABLE = "WINERYCLAW_CONTROL_UI_I18N_PI_EXECUTABLE";
const ENV_PI_ARGS = "WINERYCLAW_CONTROL_UI_I18N_PI_ARGS";
const ENV_PI_PACKAGE_VERSION = "WINERYCLAW_CONTROL_UI_I18N_PI_PACKAGE_VERSION";
const ENV_BATCH_CHAR_BUDGET = "WINERYCLAW_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "WINERYCLAW_CONTROL_UI_I18N_PROMPT_TIMEOUT";
...
const DEFAULT_GLOSSARY: readonly GlossaryEntry[] = [
  { source: "WineryClaw", target: "WineryClaw" },
