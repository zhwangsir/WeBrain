export const NPM_UPDATE_COMPAT_SIDECARS = [
  {
    ...
    content:
      "// Compatibility stub for older WineryClaw updaters. The QA channel implementation is not packaged.\nexport {};\n",
  },
  {
    path: "dist/extensions/qa-lab/runtime-api.js",
    content:
      "// Compatibility stub for older WineryClaw updaters. The QA lab implementation is not packaged.\nexport {};\n",
  },
];
