...
# WineryClaw OAuth Sync Widget
# Syncs Claude Code tokens to WineryClaw on l36 server
# Place in ~/.shortcuts/ on phone for Termux:Widget

termux-toast "Syncing WineryClaw auth..."
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    termux-toast "WineryClaw synced! Expires:${EXPIRY}"
