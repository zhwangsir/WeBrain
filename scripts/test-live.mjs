...
const env = {
  ...process.env,
  WINERYCLAW_LIVE_TEST: process.env.WINERYCLAW_LIVE_TEST || "1",
  WINERYCLAW_LIVE_TEST_QUIET: quietOverride ?? process.env.WINERYCLAW_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.WINERYCLAW_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
