...
- Keep product names in English: WineryClaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the WineryClaw Gateway, use “Gateway 网关”.
