# 😋 WineryClaw — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="docs/assets/openclaw-logo-text-dark.svg">
        <img src="docs/assets/openclaw-logo-text.svg" alt="WineryClaw" width="500">
    </picture>
</p>
...
**WineryClaw** is a _personal AI assistant_ you run on your own devices.
...
WineryClaw Onboard guides you step by step through setting up the gateway, workspace, channels, and skills. It is the recommended CLI setup path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: clone this repository and run `pnpm install && pnpm build`.
    ...
    <td align="center" width="16.66%">
      <a href="https://openai.com/">
        <picture>
          ...
          <img src="docs/assets/sponsors/openai.svg" alt="OpenAI" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://github.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="docs/assets/sponsors/github-light.svg">
          <img src="docs/assets/sponsors/github.svg" alt="GitHub" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.nvidia.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="docs/assets/sponsors/nvidia.svg">
          <img src="docs/assets/sponsors/nvidia-dark.svg" alt="NVIDIA" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://vercel.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="docs/assets/sponsors/vercel-light.svg">
          <img src="docs/assets/sponsors/vercel.svg" alt="Vercel" height="24">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://blacksmith.sh/">
        <picture>
          ...
          <img src="docs/assets/sponsors/blacksmith.svg" alt="Blacksmith" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.convex.dev/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="docs/assets/sponsors/convex-light.svg">
          <img src="docs/assets/sponsors/convex.svg" alt="Convex" height="24">
        </picture>
      </a>
    </td>
  </tr>
...
Model note: while many providers and models are supported, prefer a current flagship model from the provider you trust and already use. See onboarding for model selection.

## Models (selection + auth)

- Models config + CLI: see local docs or run `openclaw models --help`
- Auth profile rotation (OAuth vs API keys) + fallbacks: see model failover documentation
...
WineryClaw Onboard installs the Gateway daemon (launchd/systemd user service) so it stays running.

## Quick start (TL;DR)

Runtime: **Node 24 (recommended) or Node 22.16+**.

Full beginner guide (auth, pairing, channels): see local docs or run `openclaw onboard --help`
...
# Send a message
openclaw message send --to +1234567890 --message "Hello from WineryClaw"
...
Upgrading? See local docs or run `openclaw doctor` for migration guidance.
...
Details: see local documentation.
...
WineryClaw connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: see local docs or run `openclaw doctor --security`
...
- **[Local-first Gateway](docs/gateway.md)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](docs/channels.md)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), IRC, Microsoft Teams, Matrix, Feishu, LINE, Mattermost, Nextcloud Talk, Nostr, Synology Chat, Tlon, Twitch, Zalo, Zalo Personal, WeChat, WebChat, macOS, iOS/Android.
...
- **[Voice Wake](docs/nodes/voicewake.md) + [Talk Mode](docs/nodes/talk.md)** — wake words on macOS/iOS and continuous voice on Android (ElevenLabs + system TTS fallback).
- **[Live Canvas](docs/platforms/mac/canvas.md)** — agent-driven visual workspace.
- **[First-class tools](docs/tools.md)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](docs/platforms/macos.md)** — macOS menu bar app + iOS/Android nodes.
- **[Onboarding](docs/start/wizard.md) + [skills](docs/tools/skills.md)** — onboarding-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=openclaw/openclaw&type=date&legend=top-left)](https://star-history.com/#openclaw/openclaw&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](docs/gateway.md) with sessions, presence, config, cron, webhooks, [Control UI](docs/web.md), and [Canvas host](docs/platforms/mac/canvas.md).
- [CLI surface](docs/tools/agent-send.md): gateway, agent, send, [onboarding](docs/start/wizard.md), and [doctor](docs/gateway/doctor.md).
- [Pi agent runtime](docs/concepts/agent.md) in RPC mode with tool streaming and block streaming.
- [Session model](docs/concepts/session.md): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: see channels documentation.
- [Media pipeline](docs/nodes/images.md): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: see audio documentation.

### Channels

- [Channels](docs/channels.md): WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles, iMessage, IRC, Microsoft Teams, Matrix, Feishu, LINE, Mattermost, Nextcloud Talk, Nostr, Synology Chat, Tlon, Twitch, Zalo, WeChat, WebChat.
- [Group routing](docs/channels/group-messages.md): mention gating, reply tags, per-channel chunking and routing.

### Apps + nodes

- [macOS app](docs/platforms/macos.md): menu bar control plane, Voice Wake/PTT, Talk Mode overlay, WebChat, debug tools, remote gateway control.
- [iOS node](docs/platforms/ios.md): Canvas, Voice Wake, Talk Mode, camera, screen recording, Bonjour + device pairing.
- [Android node](docs/platforms/android.md): Connect tab (setup code/manual), chat sessions, voice tab, Canvas, camera/screen recording, and Android device commands.
- [macOS node mode](docs/nodes.md): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](docs/tools/browser.md): dedicated Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](docs/platforms/mac/canvas.md): A2UI push/reset, eval, snapshot.
- [Nodes](docs/nodes.md): camera snap/clip, screen record, location.get, notifications.
- [Cron + wakeups](docs/automation/cron-jobs.md); [webhooks](docs/automation/webhook.md).
- [Skills platform](docs/tools/skills.md): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](docs/channels/channel-routing.md), retry policy, and streaming/chunking.
- [Presence](docs/concepts/presence.md), typing indicators, and usage tracking.
- [Models](docs/concepts/models.md), model failover, and session pruning.
- [Security](docs/gateway/security.md) and troubleshooting.

### Ops + packaging

- [Control UI](docs/web.md) + [WebChat](docs/web/webchat.md) served directly from the Gateway.
- [Tailscale Serve/Funnel](docs/gateway/tailscale.md) or SSH tunnels with token/password auth.
- [Nix mode](docs/install/nix.md) for declarative config; Docker-based installs.
- [Doctor](docs/gateway/doctor.md) migrations, [logging](docs/logging.md).
...
- **[Gateway WebSocket network](docs/concepts/architecture.md)** — single WS control plane for clients, tools, and events.
- **[Tailscale exposure](docs/gateway/tailscale.md)** — Serve/Funnel for the Gateway dashboard + WS.
- **[Browser control](docs/tools/browser.md)** — managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](docs/platforms/mac/canvas.md)** — agent-driven visual workspace.
- **[Voice Wake](docs/nodes/voicewake.md) + [Talk Mode](docs/nodes/talk.md)** — wake words on macOS/iOS plus continuous voice on Android.
- **[Nodes](docs/nodes.md)** — Canvas, camera snap/clip, screen record, notifications.

## Tailscale access (Gateway dashboard)

WineryClaw can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (WineryClaw enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](docs/gateway/tailscale.md)
...
ClawHub registry available at clawhub.com
...
Note: signed builds required for macOS permissions to stick across rebuilds (see local documentation).
...
Runbook: see local documentation.
...
- Workspace root: `~/.wineryclaw/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.wineryclaw/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.wineryclaw/wineryclaw.json` (model + defaults):
...
Details: see local security documentation and Docker sandboxing docs.

### [WhatsApp](docs/channels/whatsapp.md)

- Link the device: `pnpm openclaw channels login` (stores creds in `~/.wineryclaw/credentials`).
...
### [BlueBubbles (iMessage)](docs/channels/bluebubbles.md)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](docs/channels/imessage.md)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](docs/channels/msteams.md)
...
- Official Tencent plugin via [`@tencent-weixin/openclaw-weixin`](https://www.npmjs.com/package/@tencent-weixin/openclaw-weixin) (iLink Bot API). Private chats only; v2.x requires WineryClaw `>=2026.3.22`.
...
- [Follow WineryClaw Onboard for a guided setup.](docs/start/wizard)
...
- [docs.openclaw.ai/gmail-pubsub](docs/automation/gmail-pubsub)

## Molty

WineryClaw was built for **Molty**, a space lobster AI assistant. 😋
...
<p align="left">
  ...
  <a href="https://github.com/mattqdev"><img src="https://avatars.githubusercontent.com/u/115874885?v=4&s=48" width="48" height="48" alt="MattQ" title="MattQ"/></a> <a href="https://github.com/Milofax"><img src="https://avatars.githubusercontent.com/u/2537423?v=4&s=48" width="48" height="48" alt="Milofax" title="Milofax"/></a> <a href="https://github.com/stevebot-alive"><img src="https://avatars.githubusercontent.com/u/261149299?v=4&s=48" width="48" height="48" alt="Steve (WineryClaw)" title="Steve (WineryClaw)"/></a> <a href="https://github.com/ZetiMente"><img src="https://avatars.githubusercontent.com/u/76985631?v=4&s=48" width="48" height="48" alt="Matthew" title="Matthew"/></a> <a href="https://github.com/Cassius0924"><img src="https://avatars.githubusercontent.com/u/62874592?v=4&s=48" width="48" height="48" alt="Cassius0924" title="Cassius0924"/></a> <a href="https://github.com/0xbrak"><img src="https://avatars.githubusercontent.com/u/181251288?v=4&s=48" width="48" height="48" alt="0xbrak" title="0xbrak"/></a> <a href="https://github.com/8BlT"><img src="https://avatars.githubusercontent.com/u/162764392?v=4&s=48" width="48" height="48" alt="8BlT" title="8BlT"/></a> <a href="https://github.com/Abdul535"><img src="https://avatars.githubusercontent.com/u/54276938?v=4&s=48" width="48" height="48" alt="Abdul535" title="Abdul535"/></a> <a href="https://github.com/abhaymundhara"><img src="https://avatars.githubusercontent.com/u/62872231?v=4&s=48" width="48" height="48" alt="abhaymundhara" title="abhaymundhara"/></a> <a href="https://github.com/aduk059"><img src="https://avatars.githubusercontent.com/u/257603478?v=4&s=48" width="48" height="48" alt="aduk059" title="aduk059"/></a>
